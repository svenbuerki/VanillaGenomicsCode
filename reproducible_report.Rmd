...
This study focuses on *Vanilla planifolia* (Orchidaceae) and the physical specimens are deposited at HEM (Universidad de Ciencias y Artes de Chiapas, Mexico) and SRP (Boise State Univeristy, Idaho, USA).
...
The `paf` file does not contain any headers, but information on the different variables is provided in Table \@ref(tab:pafheaders).
