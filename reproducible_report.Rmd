...
Merge all the `bam` files from the genome reconstruction analyses and use `bcftools` to call and filter variants. Further variant filetring will be executed in R (see below).
...
## Filtering SNPs and PCA analysis
...
library(R.utils) # Is this package used?
